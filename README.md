...
- Experience: all of the experience I've gained through societies and internships
...
1. Clone the repository: `git clone https://github.com/Sujay2478/portfoliowebsite.git`
2. Open the project folder in your preferred code editor.
3. Open the `index.html` file in a web browser to view the website.

## Website

https://sujay2478.github.io/portfoliowebsite/
